#' Perform Temporal Summary Operations Within `NEMO-ERSEM` by Model Output File Type
#'
...
#' for a chunk of NEMO-ERSEM model outputs.
#'
...
#' Condense NEMO ERSEM Model Outputs into a Summary file
#'
...
#' `temporal_operation` reduces the NEMO-ERSEM model outputs from large arrays to summaries depending on the analysis chosen.
...
#' \strong{all} the variables of interest in NEMO-ERSEM outputs.
#' @family NEMO-ERSEM variable extractors
#' @export
NEMO_ERSEM <- function(data, analysis = NULL, time_op = NULL, out_dir = "./Objects/Months", crop = NULL, summary = NULL, ...) {
