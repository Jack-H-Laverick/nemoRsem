...
#' Extract a 1D water column from NEMO-ERSEM
#'
#' These functions read in target variables from NEMO-ERSEM model outputs and return a water column.
#'
...
#' | ptrc_T_      | DIN, phytoplankton nitrogen content, phytoplankton chlorophyll, zooplankton nitrogen content, detritus, silicate.|
#'
