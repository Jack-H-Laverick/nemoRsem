...
#'
#' The function takes the spatial information for a whole NEMO-ERSEM file and determines which slice is immediately
...
#'
#' The function takes the spatial information for a whole NEMO-ERSEM file and determines how to get a depth-averaged
...
#'
#' @param space a list of latitudes, longitudes, and depths for NEMO-ERSEM model output, as returned by `get_spatial()`
#' @param bathymetry a dataframe containg the NEMO_ERSEM bathymetry.
...
#'
#' The function takes the spatial information for a whole NEMO-ERSEM file and identifies the grid point closest
...
#' `NEMO_ERSEM`. To Simply subset the depth column from model output, returning all values, use the "1D" analysis
#' option.
#'
#' @param space a list of latitudes, longitudes, and depths for NEMO-ERSEM model output, as returned by `get_spatial()`
#' @param bathymetry a dataframe containg the NEMO_ERSEM bathymetry.
